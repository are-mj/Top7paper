...
selection = false(numel(f),2);
selection(:,1) = normal&Tclass(:,2)&ok;
seltext(1) = strcat(Ttext(2)," , ",speedtext(2));
selection(:,2) = normal&Tclass(:,3)&ok;
seltext(2) = strcat(Ttext(3)," , ",speedtext(2));
